...
, function(t, e, n) {
    ...
    function yt(t) {
        ...
        var w, S, R, N = (0,
        p.default)(n, "action.config.affectedElements", {})[g || I] || {}, x = Boolean(N.id || N.selector), C = n && u(gt(n.target));
        if (x ? (w = N.limitAffectedElements,
        S = C,
        R = u(N)) : S = R = u({
            id: g,
            selector: I,
